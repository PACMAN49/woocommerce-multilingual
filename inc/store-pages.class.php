        ...
        if (is_product_taxonomy()) {
            ...
            if ($current_language != $default_language) {
                if (is_tax('destination')) {
                    $template = new Shoestrap_Wrapping();
                    $template->slug = "base";
                    $template->templates = array("taxonomy-destination.php", "base.php");
                } else if (is_tax("vehicule")) {
                    $template = new Shoestrap_Wrapping();
                    $template->slug = "base";
                    $template->templates = array("taxonomy-vehicule.php", "base.php");
                } else {
